    ...
    render() {
        ...
        return (
            <div>
                ...
                <Content>
                    <Row>
                        <ValueBox cols='12 12 4' color='green' icon='area-chart' value={`R$ ${credit}`} text='Total de Créditos' />
                        <ValueBox cols='12 12 4' color='red' icon='credit-card' value={`R$ ${debt}`} text='Total de Débitos' />
                        <ValueBox cols='12 12 4' color='blue' icon='money' value={`R$ ${credit - debt}`} text='Consolidado' />
                    </Row>
                </Content>
            </div>
        )
